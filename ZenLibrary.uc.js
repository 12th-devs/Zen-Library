...
<svg class="icon boosts-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M12 2L14.5 9H22L16 13.5L18.5 20.5L12 16L5.5 20.5L8 13.5L2 9H9.5L12 2Z"
    ...
    fill="var(--zen-folder-front-bgcolor)" fill-opacity="0"/>
                            ...
                            // A board with a pinned card on it — the shape of an easel
                            // rather than a literal easel, which reads as noise at 24px.
                            iconSvg = `
<svg class="icon easels-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <rect x="3" y="4" width="18" height="16" rx="2.5"
    stroke="var(--zen-folder-stroke)" stroke-width="2"
    fill="var(--zen-folder-front-bgcolor)" fill-opacity="0"/>
  <rect x="6.5" y="7.5" width="7" height="5" rx="1"
    stroke="var(--zen-folder-stroke)" stroke-width="1.6" fill="none"/>
  <path d="M6.5 16H17.5" stroke="var(--zen-folder-stroke)" stroke-width="1.6" stroke-linecap="round"/>
</svg>`;
                        }
